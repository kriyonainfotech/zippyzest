              ...
              <h2 className="mb-3">Orders</h2>
                ...
                {filteredOrders.length > 0 ? (
                  filteredOrders.map((orderItem) => (
                    <div
                      key={orderItem._id}
                      className="order-boxs d-flex justify-content-between align-items-center mt-3 p-2"
                      style={{
                    ...
                    >
                      <div className="col-3 d-flex justify-content-center">
                        <div className="order-img d-flex justify-content-center">
                          {orderItem.items.length > 0 && (
                            <img
                              src={`http://localhost:3000/uploads/${orderItem.items[0].product.image}`} // Adjust path as necessary
                              className="w-50"
                      ...
                      <div className="col-2 d-flex justify-content-center">
                        <div className="order-price d-flex flex-column">
                          {orderItem.items.map((item) => (
                            <div key={item.product._id}>
                      ...
                      <div className="col-4 d-flex justify-content-center">
                        <div className="order-status">
                          <button className="btn btn-primary">{orderItem.status}</button>
                        </div>
                      </div>
                    </div>
                  ))
