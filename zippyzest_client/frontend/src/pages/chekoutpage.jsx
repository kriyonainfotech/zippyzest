          ...
          <div className="row">
            ...
            <div className="col-6">
              ...
              >
                ...
                <div className="product-items-cart align-items-center d-flex justify-content-between" key={item._id}>
                  <div className="col-3 d-flex justify-content-center">
                    <div
                      className="img-cart d-flex justify-content-center"
                      style={{ border: "1px solid #e5ddd9" }}
                    >
                      <img src={`${apiurl}/uploads/${item.productId.image}?t=${new Date().getTime()}`} className="w-100" alt={item.productId.name} />
                    </div>
                  </div>
                  <div className="col-3 d-flex justify-content-center">
